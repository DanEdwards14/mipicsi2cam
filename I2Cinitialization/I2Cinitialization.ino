...
//Need to go through and find corresponding libraries for Arduino from linux libraries 
/* 
 *  #include <linux/clk.h>
...
#define IMX219_REG_VALUE_08BIT    1           //These replace register names and addresses so they are easier to read and understand
...
/* IMX219 native and active pixel array size. */            //HERE PIXEL ARRAY SIZE?
...
/* regulator supplies */                                //Need to learn purpose, might work with voltage regulators
